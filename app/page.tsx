...
//         cursor-default text-edge-outline @apply animate-title font-display sm:text-6xl md:text-6xl whitespace-nowrap bg-clip-text hide-on-small-height move-on-big-screen "style={{  textShadow: "3px 4px 50px rgba(113, 120, 122, 1)"  }}>
//           Arif Group
//         </h1>
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      />
        <h1 className=" py-3.5 px-0.5 z-10 text-4xl text-transparent duration-1000  bg-white
        cursor-default text-edge-outline @apply animate-title font-display sm:text-7xl md:text-7xl lg:text-10xl whitespace-nowrap bg-clip-text hide-on-small-height move-on-big-screen "style={{  textShadow: "3px 4px 50px rgba(113, 120, 122, 1)" }}>
          Arif Group
        </h1>
      <div className=" w-screen h-px @apply animate-glow sm:block @apply animate-fade-right bg-gradient-to-r from-zinc-300/0 via-zinc-300/50 to-zinc-300/0" />
      <div className="animate-fade-in">
